...
const SkillsSection = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Node.js", "Python", "Express.js", "FastAPI", "REST APIs", "GraphQL", "PostgreSQL", "MongoDB"]
    },
    {
    ...
    },
    {
      ...
      skills: ["Problem Solving", "Team Collaboration", "Project Management", "Communication", "Leadership", "Agile/Scrum"]
    }
  ];
